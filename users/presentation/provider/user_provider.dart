...
class UserProvider extends ChangeNotifier {
  ...
  /// Currently selected user's full data.
  UserModel? _userData;
  ...
  /// Fetches a single user's full data by their [userID].
  ...
  /// Fetches the subscription plan assigned to a user identified by [userId].
