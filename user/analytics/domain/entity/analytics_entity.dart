...
// enum AlarmMessage { fuelLevelLow, generatorFaultDetected, generatorOverload }

// final alarmMessageValues = EnumValues({
//   "Fuel Level Low": AlarmMessage.fuelLevelLow,
//   "Generator Fault Detected": AlarmMessage.generatorFaultDetected,
//   "Generator Overloaded": AlarmMessage.generatorOverload,
// });

// enum AlarmName { dgFault, lowFuel, overLoad }

// final alarmNameValues = EnumValues({
//   "DG_FAULT": AlarmName.dgFault,
//   "LOW_FUEL": AlarmName.lowFuel,
...
//   dynamic downtimeDurationMinutes;
