...
class AnalyticsModel {
  ...
  AnalyticsModel copyWith({
    ...
    mainsAnalytics: mainsAnalytics ?? this.mainsAnalytics,
  ...
  factory AnalyticsModel.fromJson(Map<String, dynamic> json) => AnalyticsModel(
    ...
    mainsAnalytics: json["mainsAnalytics"] == null
        ? null
        : MainsAnalytics.fromJson(json["mainsAnalytics"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "mainsAnalytics": mainsAnalytics?.toJson(),
...
class MainsAnalytics {
  ...
  factory MainsAnalytics.fromJson(Map<String, dynamic> json) => MainsAnalytics(
