...
import 'package:poweriot/core/common/demo/dummy_loader.dart';
import 'package:poweriot/core/common/provider/local_notification_provider.dart';
import 'package:poweriot/core/common/widgets/app_bar_menu.dart';
import 'package:poweriot/core/common/widgets/custom_button_widget.dart';
import 'package:poweriot/core/common/widgets/custom_dashboard_bar.dart';
...
import 'package:poweriot/features/news_or_feed/presentation/screen/news_feed_widget.dart';
...
import 'package:poweriot/features/user/dashboard/presentation/widgets/device_carousel_card_widget_v2.dart';
...
class _UserHomeScreenState extends State<UserHomeScreen> {
  ...
  void getUserSourceType() async {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await _dashboardProvider.connectToSocket();
  ...
  void _onPageChanged(int index, List<DashboardModel> devices) async {
    ...
    if (index >= 0 && index < devices.length) {
      _dashboardProvider.selectDevice(devices[index]);
    }
  }
        ...
        child: SingleChildScrollView(
          child: Consumer2<UserDeviceProvider, DashboardProvider>(
            builder: (context, userDeviceProvider, dashboardProvider, child) {
              debugPrint("UserHomeScreen: Consumer2 rebuild. status: ${dashboardProvider.dashboardStatus}, model length: ${dashboardProvider.dashboardModel.length}, currentPageIndex: $_currentPageIndex");
              if (dashboardProvider.dashboardModel.isNotEmpty && _currentPageIndex < dashboardProvider.dashboardModel.length) {
                final currentDev = dashboardProvider.dashboardModel[_currentPageIndex];
                debugPrint("UserHomeScreen: Current device: ${currentDev.deviceName}, mains null: ${currentDev.mains == null}, generator null: ${currentDev.generator == null}, generatorStatus: ${currentDev.generator?.status}");
              }
                ...
                children: [
                  Showcase(
                    ...
                    child: DashboardAppBar(
                      onSelected: (v) {
                        if (v.name.toString().toLowerCase() == 'profile') {
                          context.pushNamed(userSetting);
                        }
                        if (v.name.toString().toLowerCase() == 'guide') {
                        ...
                        child: SizedBox(
                          ...
                          child: PageView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return DeviceCarouselCardWidgetV2(
                                device: device,
                                isActive: isActive,
                              );
                            },
                      ...
                      if (dashboardProvider
                        ...
                        Showcase(
                          ...
                          child: S3PowerSourcesRow(
                            ...
                            onTapGenerator: () {
                              ...
                              //         body:
                              //             "Mains power supply is available. The generator has stopped.",
                              //       );
                              // }
                              // if (dashboardProvider
                              //             .dashboardModel[_currentPageIndex]
                              ...
                              //         body:
                              //             "Mains power supply is unavailable. The generator has started automatically and is supplying power.",
                              //       );
                              //   service<LocalNotificationProvider>()
                              //       .showNotificaion(
                              //         id: 2,
                            ...
                            currentPowerSource:
                                ...
                                ? dashboardProvider
                                      ...
                                      .toString()
                                : "",
                            hasMIANS: dashboardProvider.planExpired == false
                                ? dashboardProvider
                                          .dashboardModel[_currentPageIndex]
                                          .mains !=
                                      null
                        ...
                        Showcase(
                          ...
                          child: S3MainPowerCard(
                            dashboardModel: dashboardProvider
                                .dashboardModel[_currentPageIndex],
                            mains: dashboardProvider.planExpired == false
                                ? dashboardProvider
                                      .dashboardModel[_currentPageIndex]
                                      .mains
                                : null,
                        ...
                        LatestNewsCarousel(news: powerNewsList),
                      ],
                    ],
