...
class DeviceCarouselCardWidgetV2 extends StatelessWidget {
  final DashboardModel device;
  final bool isActive;

  const DeviceCarouselCardWidgetV2({
    super.key,
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: isActive
              ? [theme.primaryColor.withValues(alpha: 0.85), theme.primaryColor]
              : [
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  context.read<DashboardProvider>().fetchMySubscriptionMethod();
                },
                child: StatusChip(
                  label:
              ...
              children: [
                ...
                _buildRuntimeItem(
                  ...
                  value: formatMinutesToHours(
                    device.mains!.mainsOnRuntimeInHourUsingBillingCycleInHours!,
                  ),
                  icon: Icons.electrical_services,
                  accentColor: const Color(0xFF4ADE80),
                  unitsValue: device.mains!.meterReading != null
                      ? '${device.mains!.meterReading!.toStringAsFixed(2)} Units'
                      : "-",
                ),
                Container(
                  height: 24,
                ...
                _buildRuntimeItem(
                  ...
                  label: device.mains != null
                      ...
                      : '',
                  value:
                      "${getMinutesBetweenDates(fromDate: DateTime(DateTime.now().year, DateTime.now().month, 01), toDate: DateTime.now()).toString()} hr",
