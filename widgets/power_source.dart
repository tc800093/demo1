...
class S3PowerSourcesRow extends StatelessWidget {
  ...
  final double mainsTodayHours;
  final double generatorTodayHours;
  ...
  const S3PowerSourcesRow({
    ...
    this.mainsTodayHours = 21.0,
    this.generatorTodayHours = 3.0,
    this.onTapGenerator,
    this.onTapMains,
  });
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: theme.textTheme.bodySmall!.copyWith(
                    fontSize: 11,
                    color: isOn ? Colors.white : theme.textTheme.bodySmall?.color,
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  'Today: ${todayHours.toStringAsFixed(1)} hrs',
                  style: theme.textTheme.bodySmall!.copyWith(
                    fontSize: 11,
                    fontWeight: FontWeight.bold,
                    color: theme.primaryColor,
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: hasGenerator
                      ? (isOn ? AppStatusColors.success : Colors.grey.withValues(alpha: 0.2))
