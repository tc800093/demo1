...
class OutageGraphWidget extends StatelessWidget {
  ...
  List<FlSpot> _buildSpots() {
    ...
    if (isSameDay) {
      ...
      for (final segment in segments) {
        final date2 = DateTime(segment.start.year, segment.start.month, segment.start.day);
        final dayOffset = date2.difference(date1).inDays;
  ...
  double _maxX() {
    ...
    final date1 = DateTime(fromDate.year, fromDate.month, fromDate.day);
    final date2 = DateTime(toDate.year, toDate.month, toDate.day);
    return math.max(1, (date2.difference(date1).inDays).toDouble());
  }
  ...
  double _bottomInterval() {
    ...
    final date1 = DateTime(fromDate.year, fromDate.month, fromDate.day);
    final date2 = DateTime(toDate.year, toDate.month, toDate.day);
    final totalDays = date2.difference(date1).inDays + 1;
