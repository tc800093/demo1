        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: ProfileColors.cardBorder, width: 1.5),
            ),
            child: Center(
              child: Text(
                'AV',
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Icon(Icons.settings_rounded,
                  color: ProfileColors.textSecondary, size: 18),
            ),
          ),
        ],
      ),
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: ProfileColors.yellow.withOpacity(0.15),
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(
                      color: ProfileColors.yellow.withOpacity(0.4)),
                ),
                child: Text(
                  'AUTH: LEVEL 4',
                  style: GoogleFonts.inter(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: ProfileColors.yellow.withOpacity(0.3),
                        blurRadius: 12,
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 36,
                    decoration: BoxDecoration(
                      color: ProfileColors.yellow.withOpacity(0.12),
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
                          color: ProfileColors.yellow.withOpacity(0.3)),
                    ),
                    child: const Icon(Icons.bolt_rounded,
                        color: ProfileColors.yellow, size: 20),
                  ),
                ],
              ),
              const SizedBox(height: 14),
              ...
              Row(
                children: [
                  _InfoField(
                      label: 'Customer Number', value: '#4492-3301'),
                  _InfoField(
                      label: 'Meter ID', value: 'MTR-88219-Q'),
                ],
              ),
              ...
              Row(
                children: [
                  _InfoField(
                      label: 'Connection',
                      value: '3-Phase Industrial'),
                  _InfoField(
                      label: 'Service Type',
                      value: 'High-Voltage Line'),
                ],
              ),
              const SizedBox(height: 12),
              // Service Address
              ...
              Row(
                children: [
                  const Icon(Icons.location_on_rounded,
                      color: ProfileColors.textSecondary, size: 13),
                  const SizedBox(width: 5),
                  Expanded(
                    child: Text(
                  ...
                  child: Row(
                    ...
                    children: [
                      const Icon(Icons.tune_rounded,
                          color: ProfileColors.textSecondary, size: 16),
                      const SizedBox(width: 8),
                      Text(
                        'Update Parameters',
                        style: GoogleFonts.inter(
